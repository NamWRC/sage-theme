    ...
    <div class="container mb-3 md:left-15p md:w-70p z-10 absolute bottom-0 w-full flex flex-col items-center md:flex-row md:flex-wrap">
      <div class="flex flex-col items-center w-full md:max-w-30p md:items-start">
        ...
        <div class="flex mb-12">
            <img class="m-2" src="<?php echo App::getFooterImg()['yt']; ?>" alt="<?php echo App::getFooterImg()['alt']; ?>">
            <img class="m-2" src="<?php echo App::getFooterImg()['ig']; ?>" alt="<?php echo App::getFooterImg()['alt']; ?>">
            <img class="m-2" src="<?php echo App::getFooterImg()['tw']; ?>" alt="<?php echo App::getFooterImg()['alt']; ?>">
            <img class="m-2" src="<?php echo App::getFooterImg()['fb']; ?>" alt="<?php echo App::getFooterImg()['alt']; ?>">
